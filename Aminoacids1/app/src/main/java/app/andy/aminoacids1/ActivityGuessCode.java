...
/**
 * Created by Andrey Borzenko on 10.03.2017.
 */

public class ActivityGuessCode extends ActivityWithLocales {

    FragmentPagerAdapter adapterViewPager;
  //  public static ActivityGuessCode mInstance = null;
    public static int lang = 0;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_guessname);
        ...
        adapterViewPager = new ActivityGuessCode.MyPagerAdapter(getSupportFragmentManager(),aminocodes);
    ...
    public class MyPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            if(position<codes.length) {
                return GuessCodeFragment.newInstance(position,codes[position]);
            }

            return ResultFragment.getInstance(GuessCodeFragment.counter,codes.length);
        }
