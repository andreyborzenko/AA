...
public class ActivityGuessFormula extends ActivityWithLocales {
    FragmentPagerAdapter adapterViewPager;
  //  public static ActivityGuessFormula mInstance = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapterViewPager = new MyPagerAdapter(getSupportFragmentManager(),aminocodes);
    ...
    class Question implements Serializable {
        String code;
        String question;
        ArrayList<QuestionVariant> answers;
    }
    ...
    public class MyPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            if(position<codes.length) {
                return FirstFragment.newInstance(position,codes[position]);
            }
