...
public class ActivityGuessName extends ActivityWithLocales {

    FragmentPagerAdapter adapterViewPager;
  //  public static ActivityGuessName mInstance = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapterViewPager = new ActivityGuessName.MyPagerAdapter(getSupportFragmentManager(),aminocodes);
    ...
    public class MyPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            if(position<codes.length) {
                return GuessNameFragment.newInstance(position,codes[position]);
            }

            return ResultFragment.getInstance(GuessNameFragment.counter,codes.length);
        }
